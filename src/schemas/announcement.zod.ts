...
export const validateAnnouncement = (data: unknown) => announcementSchema.parse(data);
export const validateAnnouncementUpdate = (data: unknown) => announcementUpdateSchema.parse(data);
