...
const baseCustomerSchema = z.object({
    ...
    org_handle: z.string()
        ...
        .regex(/^[a-zA-Z0-9_-]+$/, "Organization handle can only contain letters, numbers, underscores, and hyphens")
        .trim(),
    timezone: z.string()
    ...
    phone: z.string()
        ...
        .optional(),
    oauth_providers: z.array(oauthProviderSchema)
...
export const validateCustomerUpdate = (data: unknown) => customerUpdateSchema.parse(data);
